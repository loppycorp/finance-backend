    ...
    return {
        ...
        window: {
            ...
            additional_criteria_for_list_selection: {
                ...
                group_counter: data.window.additional_criteria_for_list_selection.group_counter,
                task_list_status: data.window.additional_criteria_for_list_selection.task_list_status,
                planner_group: data.window.additional_criteria_for_list_selection.planner_group,
            },
        },
        items: {
            operation_overview: {
