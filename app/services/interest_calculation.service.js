    ...
    filters.$or = [
      {
        ...
        "window_1.accounting_information.recon_account": search,
        "window_1.accounting_information.head_office": search,
        "window_1.accounting_information.authorization": search,
        "window_1.accounting_information.minority_indic": search,
        "window_1.accounting_information.sort_key": search,
        "window_1.accounting_information.subsidy_indic": search,
        "window_1.accounting_information.cash_mgmnt_group": search,
        "window_1.accounting_information.release_group": search,
        "window_1.accounting_information.certificatn_date": search,
        "window_2.interest_calculation.interest_indic": search,
        "window_2.interest_calculation.interest_freq": search,
        "window_2.interest_calculation.last_key_date": search,
        "window_2.interest_calculation.last_interest_run": search,
        "window_3.reference_data.prev_acc_no": search,
        "window_3.reference_data.personnel_number": search,
        "window_4.default_data_for_tax_reports.activity_code": search,
        "window_4.default_data_for_tax_reports.distr_type": search,
      },
    ];
  }
