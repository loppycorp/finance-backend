...
const DefaultModel = require('../models/cost_element_category.model');
...
exports.getByCode = async (code, existing_id) => {
    const options = { code: code, status: DefaultModel.STATUS_ACTIVE };
...
exports.getByName = async (name, existing_id) => {
    const options = { name: name, status: DefaultModel.STATUS_ACTIVE };
