...
exports.search = async (searchTerm, options = {}) => {
  ...
  if (searchTerm) {
    ...
    filters.$or = [
      ...
      { "header.paying_company_code_to": search },
      { "header.house_bank": search },
      { "header.house_bank_to": search },
      { "header.account_id": search },
      { "header.account_id_to": search },
      { "header.payroll_checks": search },

      { "general_selection.general_selection.bank_key": search },
      { "general_selection.general_selection.bank_key_to": search },
      { "general_selection.general_selection.bank_account": search },
      { "general_selection.general_selection.bank_account_to": search },
      { "general_selection.general_selection.check_number": search },
      { "general_selection.general_selection.check_number_to": search },
      { "general_selection.general_selection.currency": search },
      { "general_selection.general_selection.currency_to": search },
      { "general_selection.general_selection.amount": search },
      { "general_selection.general_selection.amount_to": search },

      { "general_selection.output_control.list_of_outstanding_checks": search },
      { "general_selection.output_control.additional_heading": search },
    ];
  }
...
exports.mapData = (data) => {
  ...
  const generalSelection =
    data.general_selection && data.general_selection.general_selection
  ...
  return {
    ...
    header: {
      paying_company_code: company_code
        ...
        : null,
      paying_company_code_to: data.header
        ? data.header.paying_company_code
        : null,
      ...
      account_id: account_id
        ? {
            ...
            description: account_id.type_description
              ? account_id.type_description.description.short_text
              : null,
          }
        : null,
      ...
      general_selection: {
        bank_key: bank_keys
          ? {
              ...
              region: bank_keys.details
                ? bank_keys.details.address.region
                : null,
            }
          : null,
