    ...
    filters.$or = [
      {
        ...
        "header.status": statusSearch,

        "general.quantities.total_qty": totalQtySearch,
        "general.quantities.delivered": deliveredSearch,
        "general.quantities.scrap_portion": scrapPortionSearch,
        "general.quantities.expect_yield_var": expectYieldVarSearch,

        "general.basic_dates.finish": finishDateSearch,
        "general.basic_dates.start": startDateSearch,
        "general.basic_dates.release": releaseDateSearch,

        "general.scheduled.finish": scheduledFinishDateSearch,
        "general.scheduled.start": scheduledStartDateSearch,
        "general.scheduled.release": scheduledReleaseDateSearch,

        "general.confirmd.finish": confirmedFinishDateSearch,
        "general.confirmd.start": confirmedStartDateSearch,
        "general.confirmd.release": confirmedReleaseDateSearch,
      },
    ];
  }
