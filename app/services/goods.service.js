...
exports.mapData = (data) => {
    const { company_code, currency, fiscal_year, ledger_group, posting_key, account, cost_center, profit_center, segment } = data;
    ...
    const cost_centers = Array.isArray(data.cost_centers) ? data.cost_centers : [];
    ...
    return {
        ...
        items: itemsArray.map((o) => {
            ...
            const itemCostCenter = cost_centers.find(i => i._id.toString() == o.cost_center.toString());
