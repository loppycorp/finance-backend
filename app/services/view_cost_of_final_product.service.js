    ...
    filters.$or = [
      {
        ...
        "window.costing_data.costing_variant": search,
        "window.costing_data.costing_version": search,
        "window.costing_data.costing_lot_size": search,
        "window.costing_data.transfer_control": search,

        "window.costs.costs_based_on": search,

        "window.costs.component_view.cost_component_view": search,
        "window.costs.component_view.total_costs": search,
        "window.costs.component_view.fixed_costs": search,
        "window.costs.component_view.variable": search,
        "window.costs.component_view.currency": search,

        "window.costs.items.i": search,
        "window.costs.items.resource": search,
        "window.costs.items.cost_element": search,
        "window.costs.items.total_value": search,
        "window.costs.items.fixed_value": search,
        "window.costs.items.currency": search,
      },
    ];
  }
  ...
  return {
    ...
    window: {
      ...
      costs: {
        ...
        component_view: {
          cost_component_view:
            data.window.costs.component_view.cost_component_view,
