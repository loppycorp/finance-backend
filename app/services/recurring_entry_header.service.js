...
const DefaultModel = require("../models/recurring_entry_header.model");
...
exports.mapData = (data) => {
  return {
    ...
    recurring_entry_run: data.recurring_entry_run,
    document_header_information: data.document_header_information,
    status: data.status,
