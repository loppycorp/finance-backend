    ...
    filters.$or = [
      {
        ...
        "header.plant": search,
        "header.alternative_bom": search,

        "items.items.ict": search,
        "items.items.component": search,
        "items.items.conponent_description": search,
        "items.items.quantity": search,
        "items.items.un": search,
        "items.items.as": search,
        "items.items.sis": search,
        "items.items.valid_from": search,
        "items.items.valid_to": search,
      },
    ];
  }
