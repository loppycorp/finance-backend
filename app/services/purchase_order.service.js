    ...
    filters.$or = [
      {
        ...
        "header.doc_date": search,

        "window.org_data.purchasing_org": search,
        "window.org_data.purch_group": search,
        "window.org_data.company_code": search,

        "window.additional_data.validity_start": search,
        "window.additional_data.validity_end": search,
        "window.additional_data.collective_no": search,

        "window.account_assignments.acc_ass_cat": search,
        "window.account_assignments.distribution": search,
        "window.account_assignments.co_code": search,
        "window.account_assignments.unloading_point": search,
        "window.account_assignments.recipient": search,
        "window.account_assignments.gl_account": search,
        "window.account_assignments.co_area": search,
        "window.account_assignments.cost_center": search,
        "window.account_assignments.order": search,
        "window.account_assignments.network": search,

        "window.invoice.tax_code": search,

        "condition.condition.qty": search,
        "condition.condition.net": search,
        "condition.condition.currency": search,

        "condition.items.cnty": search,
        "condition.items.name": search,
        "condition.items.amount": search,
        "condition.items.per": search,
        "condition.items.condition_value": search,
        "condition.items.curr": search,
        "condition.items.status": search,
        "condition.items.numc": search,
        "condition.items.oun": search,
        "condition.items.cdcur": search,
      },
    ];
  }
...
exports.mapData = (data) => {
  ...
  const itemsArray = Array.isArray(data.condition.items)
