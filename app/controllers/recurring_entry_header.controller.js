...
const DefaultService = require("../services/recurring_entry_header.service");
const {
  createSchema,
  updateSchema,
} = require("../helpers/validations/recurring_entry_header.validation");
...
exports.create = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("recurring_entry_header.suc.create"),
      data: defaultService,
    });
  } catch (err) {
...
exports.search = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("recurring_entry_header.suc.search"),
      data: data,
      pagination: {
        page_num: pageNum,
...
exports.update = async (req, res) => {
  try {
    ...
    if (!defaultService) {
      return res.status(400).send({
        status: "error",
        message: lang.t("recurring_entry_header.err.not_exists"),
      });
    }
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("recurring_entry_header.suc.update"),
...
exports.delete = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("recurring_entry_header.suc.delete"),
