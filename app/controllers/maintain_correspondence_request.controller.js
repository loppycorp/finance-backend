...
const DefaultService = require("../services/maintain_correspondence_request.service");
const {
  createSchema,
  updateSchema,
} = require("../helpers/validations/maintain_correspondence_request.validation");
...
exports.create = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("maintain_correspondence_request.suc.create"),
      data: defaultService,
    });
  } catch (err) {
    logger.error(req.path);
...
exports.search = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("maintain_correspondence_request.suc.search"),
      data: data,
      pagination: {
        page_num: pageNum,
        page_limit: pageLimit,
...
exports.update = async (req, res) => {
  try {
    ...
    if (!defaultService) {
      return res.status(400).send({
        status: "error",
        message: lang.t("maintain_correspondence_request.err.not_exists"),
      });
    }
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("maintain_correspondence_request.suc.update"),
...
exports.delete = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("maintain_correspondence_request.suc.delete"),
