...
const DefaultService = require("../services/gl_account_document.service");
const {
  createSchema,
  updateSchema,
} = require("../helpers/validations/gl_account_document.validation");
...
exports.create = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_document.suc.create"),
      data: defaultService,
    });
  } catch (err) {
...
exports.search = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_document.suc.search"),
      data: data,
      pagination: {
        page_num: pageNum,
...
exports.update = async (req, res) => {
  try {
    ...
    if (!defaultService) {
      return res.status(400).send({
        status: "error",
        message: lang.t("gl_account_document.err.not_exists"),
      });
    }
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_document.suc.update"),
...
exports.delete = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_document.suc.delete"),
