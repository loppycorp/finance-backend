...
const DefaultService = require("../services/gl_account_item.service");
const {
  createSchema,
  updateSchema,
} = require("../helpers/validations/gl_account_item.validation");
...
exports.create = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_item.suc.create"),
      data: defaultService,
    });
  } catch (err) {
...
exports.search = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_item.suc.search"),
      data: data,
      pagination: {
        page_num: pageNum,
...
exports.update = async (req, res) => {
  try {
    ...
    if (!defaultService) {
      return res.status(400).send({
        status: "error",
        message: lang.t("gl_account_item.err.not_exists"),
      });
    }
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_item.suc.update"),
...
exports.delete = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("gl_account_item.suc.delete"),
