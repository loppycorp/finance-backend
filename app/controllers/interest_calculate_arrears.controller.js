...
const DefaultService = require("../services/interest_calculate_arrears.service");
const {
  createSchema,
  updateSchema,
} = require("../helpers/validations/interest_calculate_arrears.validation");
...
exports.create = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("interest_calculate_arrears.suc.create"),
      data: defaultService,
    });
  } catch (err) {
    logger.error(req.path);
...
exports.search = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("interest_calculate_arrears.suc.search"),
      data: data,
      pagination: {
        page_num: pageNum,
        page_limit: pageLimit,
...
exports.update = async (req, res) => {
  try {
    ...
    if (!defaultService) {
      return res.status(400).send({
        status: "error",
        message: lang.t("interest_calculate_arrears.err.not_exists"),
      });
    }
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("interest_calculate_arrears.suc.update"),
...
exports.delete = async (req, res) => {
  try {
    ...
    return res.status(200).send({
      status: "success",
      message: lang.t("interest_calculate_arrears.suc.delete"),
