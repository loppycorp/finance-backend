...
const defaultSchema = Joi.object({
    ...
    control_data: {
        ...
        reference_data: {
            location_one: Joi.string().trim().required().max(LIMIT_DEFAULT_CHAR).allow(''),
            location_two: Joi.string().trim().required().max(LIMIT_DEFAULT_CHAR).allow(''),
            check_digit: Joi.string().trim().required().max(LIMIT_DEFAULT_CHAR).allow(''),
            industry: Joi.string().trim().required().max(LIMIT_DEFAULT_CHAR).allow(''),
        },
    },
    payment_transactions: {
        ...
        payment_transactions: {
            alternative_payer: Joi.string().trim().required().max(LIMIT_DEFAULT_CHAR).allow(''),
        },
        alternative_payee: {
