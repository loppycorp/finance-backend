...
const defaultSchema = Joi.object({
    ...
    payment_transactions: {
        payment_data: {
            ...
            chk_double_inv: Joi.string().trim().required().Boolean(),
        },
        auto_payment_transactions: {
            ...
            individual_pmnt: Joi.string().trim().required().Boolean(),
            exch_limit: Joi.number().integer().allow(''),
            pmnt_adv: Joi.string().trim().required().Boolean(),
    ...
    correspondence: {
        ...
        correspondences: {
            local_process: Joi.string().trim().required().Boolean(),
