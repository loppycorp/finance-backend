...
const defaultSchema = Joi.object({
    ...
    lot: {
        lot: {
            lot_number: Joi.number().integer().required(),
            cheque_number_from: Joi.number().integer().required(),
            cheque_number_to: Joi.number().integer().required(),
        },
        control_data: {
            next_lot_number: Joi.number().integer().required().allow(null),
