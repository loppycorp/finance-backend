...
const defaultSchema = Joi.object({
    ...
    basic_data: {
        ...
        cost_ctr_category_id: Joi.string().trim().hex().max(24).allow('', null),
        hierarchy_area_id: Joi.string().trim().hex().max(24).allow('', null),
        ...
        currency_id: Joi.string().trim().required().hex().max(24),
