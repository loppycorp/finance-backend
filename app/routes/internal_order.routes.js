...
module.exports = (app) => {
  ...
  app.get(
    process.env.BASE_URL + "/internal-order",
    pagination.setAttributes,
    internal_order.search
  );
  // Edit primary cost element
  app.put(process.env.BASE_URL + "/internal-order/:id", internal_order.update);
  // Delete internal_order
  app.delete(
    process.env.BASE_URL + "/internal-order/:id",
    internal_order.delete
  );
  //search
  app.get(
    process.env.BASE_URL + "/internal-order-search",
    pagination.setAttributes,
    internal_order.defaultsearch
  );
};
