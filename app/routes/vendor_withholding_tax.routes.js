...
const defaultController = require('../controllers/vendor_withholding_tax.controller');
const auth = require('../middlewares/authorization.middleware');
const pagination = require('../middlewares/pagination.middleware');

module.exports = (app) => {
    // Create new account record
    app.post(process.env.BASE_URL + '/vendor-withholding-tax', auth.validateToken, defaultController.create);
    ...
    app.delete(process.env.BASE_URL + '/vendor-withholding-tax/:id', auth.validateToken, defaultController.delete);
};