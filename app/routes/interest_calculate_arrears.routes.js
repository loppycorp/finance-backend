...
module.exports = (app) => {
  ...
  app.post(
    process.env.BASE_URL + "/interest-calculate-arrears",
    auth.validateToken,
  ...
  //search
  app.get(
    process.env.BASE_URL + "/interest-calculate-arrears-search",
    auth.validateToken,
  ...
  // View account record
  app.get(
    process.env.BASE_URL + "/interest-calculate-arrears/:id",
    auth.validateToken,
    defaultController.search
  );
