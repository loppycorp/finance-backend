...
const costCtrSchema = new mongoose.Schema({
    ...
    basic_data: {
        user_responsible_id: { type: mongoose.SchemaTypes.ObjectId, required: false, ref: 'users' },
        person_responsible_id: { type: mongoose.SchemaTypes.ObjectId, required: false, ref: 'users' },
        ...
        company_id: { type: mongoose.SchemaTypes.ObjectId, required: false, ref: 'company' },
