...
const houseBankSchema = new mongoose.Schema({
  header: {
    company_code: {
    ...
    house_bank_code: { type: String, trim: true, required: true },
    bank_country: {
      type: mongoose.SchemaTypes.ObjectId, required: false, ref: "countries",
    },
...
module.exports = mongoose.model("house_bank", houseBankSchema);
