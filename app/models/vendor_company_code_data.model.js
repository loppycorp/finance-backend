...
const vendorCompanyCodeData = new mongoose.Schema({
    ...
    account_management: {
        accounting_information: {
            ...
            cash_mgmnt_group: { type: mongoose.SchemaTypes.ObjectId, required: true, ref: 'cash_mgmnt_grooups' },
            release_group: { type: mongoose.SchemaTypes.ObjectId, required: true, ref: 'release_groups' },
