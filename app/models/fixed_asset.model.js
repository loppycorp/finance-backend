...
const DefaulSchema = new mongoose.Schema({
    ...
    basic_data1: {
        general_data: {
            base_unit_of_measure: { type: String, trim: true, required: true },
            ...
            material_group: { type: mongoose.SchemaTypes.ObjectId, required: true, ref: 'material_groups' },
    ...
    purchasing: {
        general_data: {
            ...
            purchasing_group: { type: mongoose.SchemaTypes.ObjectId, required: true, ref: 'purchasing_groups' },
    ...
    foreign_trade_import: {
        ...
        excise_data: {
            ...
            valid_from: { type: Date, default: () => new Date(), required: false },
            currency_key: { type: mongoose.SchemaTypes.ObjectId, required: true, ref: 'currencies' },
    ...
    accounting_1: {
        ...
        current_valuation: {
            valuation_class: { type: String, trim: true, required: true },
